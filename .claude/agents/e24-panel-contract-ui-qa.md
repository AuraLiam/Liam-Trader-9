...
قبل از هر تحلیل: `python3 -m hamid.dispatch --bucket E24` (یا
...
`python3 -m hamid.data_requests --add E24 <kline|feed|state> k=v …` ثبت
کن؛ هر ۵ دقیقه جمع می‌شود و با `python3 -m hamid.data_requests --for E24`
