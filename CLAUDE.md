...
**وضعیت:** قانون تازه است و کارنامهٔ CI-دار ندارد. دفتر پیپرش جداست
(`stage="shock"`، ورک‌فلوی shock-desk دقایق ۹/۲۴/۳۹/۵۴) و روی وتوها اثر
نمی‌گذارد. تا وقتی بازهٔ اطمینانش از صفر رد نشود، **فقط پیپر**.
پیاده‌سازی: `liam9_shock.py` · `liam9_link.py` · `hamid/shock_desk.py` ·
محافظ: `hamid/test_shock.py` (۴۴ آزمون).
