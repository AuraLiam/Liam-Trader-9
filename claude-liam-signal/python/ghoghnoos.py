#!/usr/bin/env python3
"""ققنوس — موتور استراتژی داشبورد «لیام تریدر ۹» (نسخهٔ ۳.۱ فشرده)

نام موتور: **ققنوس** — همان ایجنت اصلی که شورای دوازده
...
ساخت: 2026-09-11 14:29 UTC · کامیت c431cddc4a
