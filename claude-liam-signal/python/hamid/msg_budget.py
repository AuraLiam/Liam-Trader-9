...
# trade_mgmt (۱۵ سپتامبر): پلهٔ تریل روی معاملهٔ ارسالی — دستورِ عمل برای
# حمید، مثل نتیجه؛ تعدادش را پوزیشن‌های باز تعیین می‌کند نه کادنس. تا
# دیروز زیر «alert» شمرده می‌شد و ۱۷ از ۵۸ آلارمِ روز را می‌ساخت.
NO_BUDGET = {"outcome", "trade_mgmt"}
OBSERVE_ONLY = {
