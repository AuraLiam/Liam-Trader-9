...
ROOMS = {
    ...
    # اتاق فومو (۲ سپتامبر): شاهدِ دستی از اپ fomo. کارنامه‌اش این‌جا شمرده
    # می‌شود تا وزنش از عملکرد بیاید؛ سقف لایهٔ اجتماعی ۵٪ رأی (قانون ۱۱).
    "fomo": {"engine": "E15", "label": "شاهد فومو (اپ)",
             "fields": {"fomo_witness": _bool_vote},
             "rule": "رأی = برای همین نماد در ۲۴ ساعت اخیر شاهدِ فومو ثبت شده بود"},
}
